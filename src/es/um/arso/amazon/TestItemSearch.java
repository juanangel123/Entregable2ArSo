...
public class TestItemSearch {
	...
	public static void main(String[] args) {
		TestItemSearch ist = new TestItemSearch();
		ist.runSearch();
	}
	...
	public void runSearch() {
		...
		for (int i = 0; i < resultadosBusqueda.size(); ++i) {
			...
			// Fecha en la que sale a la venta
			System.out.println("Release date: " + attributes.getReleaseDate());
			System.out.println("Studio: " + attributes.getStudio());
			System.out.println("Title: " + attributes.getTitle());
			// No hace falta actores (ya definidos en la desc. de la pelicula)
			List<String> lista = attributes.getActor();
//			for (String str : lista) {
//				System.out.println("Actor: " + str);
//			}
			System.out.println("Discos: " + attributes.getNumberOfDiscs());
